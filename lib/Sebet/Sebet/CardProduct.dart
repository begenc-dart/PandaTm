        ...
        Checkbox(
          ...
          onChanged: (value) {
            widget.orders.length != 0
                ? value == true
                ? {
              ref.watch(CounterState.provider)[widget.index][widget.proindex] =
                  widget.order.quantity,
              ref.read(PriceState.pricepro.notifier).addindex(widget.index,
                  widget.order.price *
                      ref.watch(CounterState.provider)[widget.index][widget
                          .proindex]),
              ...
              widget.order.quantity =
              ref.watch(CounterState.provider)[widget.index][widget.proindex],
              ref.read(PriceState.pricepro.notifier).remove(widget.index,
                  widget.order.price *
                      ref.watch(CounterState.provider)[widget.index][widget
                          .proindex]),
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        fit: BoxFit.fill,
                        height: 80,
                        imageUrl: "${IpAddress().ipAddress}/${widget.order.image}",
                    ...
                    Flexible(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                             widget.url=="ru"?widget.order.nameRu.toString(): widget.order.nameTm.toString(),
                            ...
                            InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                    widget.order.size!=null? widget.order.productColor==null? "": widget.order.productColor![0].colorNameTm+" " + widget.order.size.toString():"",
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                onTap: ref.watch(CounterState
                                                   ...
                                                   widget
                                                      ...
                                                      true
                                                      ? {
                                                    ref.read(CounterState.provider
                                                        .notifier).remove(
                                                        widget.index,
                                                        widget.proindex),
                                                    ref.read(PriceState.pricepro
                                                        .notifier).remove(
                                                        widget.index,
                                                        widget.order.price),
                                              ...
                                              Text(
                                                widget.order.isSelected ==
                                                    true ? ref.watch(
                                                    CounterState.provider)[widget
                                                    .index][widget.proindex]
                                                    .toString() : widget.order
                                                    .quantity.toString(),
                                        ...
                                        child: InkWell(
                                            onTap: () {
                                              ...
                                              widget.orders.removeAt(
                                                  widget.proindex);
widget.order.isSelected==true? ref.read(PriceState.pricepro.notifier).remove(widget.index,
    widget.order.price *
        ref.watch(CounterState.provider)[widget.index][widget
            .proindex]):"";
...
//
                                              ...
                                              ref
                                                  .read(
                                              PriceState.pricepro.notifier).removeprice(widget.index)
                                                // productIndex.removeall(widget.index)
                                              }
                                                  : "";
                                              ref
                                                  .read(
                                                  CounterState.provider.notifier).removepro(widget.index, widget.proindex);
                                              widget.refres();
                                            },
                                            child: Icon(
                                              Icons.delete,
