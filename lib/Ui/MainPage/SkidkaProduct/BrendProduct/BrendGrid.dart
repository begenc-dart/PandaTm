...
class BrendGrid extends StatefulWidget {
  List<Datum> brend;
  String url;
  BrendGrid({required this.brend,required this.url});

  @override
  State<BrendGrid> createState() => _BrendGridState();
}

class _BrendGridState extends State<BrendGrid> {
  int a=0;
  @override
