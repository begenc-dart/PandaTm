...
//
//     final ownProductModel = ownProductModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

OwnProductModel ownProductModelFromJson(String str) => OwnProductModel.fromJson(json.decode(str));

String ownProductModelToJson(OwnProductModel data) => json.encode(data.toJson());
...
class OwnProductModel {
  ...
  factory OwnProductModel.fromJson(Map<String, dynamic> json) => OwnProductModel(
    count: json["count"],
    rows: List<OwnRow>.from(json["rows"].map((x) => OwnRow.fromJson(x))),
  );
...
class OwnRow {
  ...
  factory OwnRow.fromJson(Map<String, dynamic> json) => OwnRow(
    id: json["id"],
