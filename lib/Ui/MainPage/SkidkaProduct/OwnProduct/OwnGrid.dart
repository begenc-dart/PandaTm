...
class OwnGrid extends StatefulWidget {
  List<OwnRow> brend;
  OwnGrid({required this.brend});

  @override
  State<OwnGrid> createState() => _OwnGridState();
}

class _OwnGridState extends State<OwnGrid> {
  @override
  int a=0;
            ...
            onTap: () {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => ProductDetails(
                    productId: widget.brend[index].productId,
                    image: widget.brend[index].images,
                  )));
            },
            child: Container(
              height: 200,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(widget.brend[index].nameTm,
                          ...
                          Padding(
                            ...
                            child: Text(widget.brend[index].bodyTm,
