                                  ...
                                  onTap: () {
                                    Navigator.of(context).push(
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                ProductDetails(
                                                  productId:  snapshot.data!.actionProducts.rows[index]
                                                      .productId,
                                                  image:  snapshot.data!.actionProducts.rows[index]
                                                      .images,
                                                )));
                                  },
                                  child: Container(
                                      ...
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.only(
                                              top: 7),
                                          child:  snapshot.data!.actionProducts.rows[index]
                                              .images.length ==
                                              0
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              imageUrl:
                                              "${IpAddress().ipAddress}/" +
    snapshot.data!.actionProducts.rows[index]
                                                      .images[0]
                                                      .image,
                                        ...
                                        Text(
                                          url == "ru"
                                              ?  snapshot.data!.actionProducts.rows[index].nameRu
                                              :  snapshot.data!.actionProducts.rows[index].nameTm,
                                          maxLines: 1,
